...
class JaxaEarthProvider(AbstractBaseProvider):
    ...
    REQUIRES_AUTH = False
    DESCRIPTION = "ALOS World 3D DSM, ALOS PALSAR global mosaics. Free, no login required."
    ...
    def authenticate(self, credentials: Credentials) -> AuthSession:
        ...
        if self.REQUIRES_AUTH and not token and not credentials.username:
            raise AuthenticationError(
                f"{self.DISPLAY_NAME} requires credentials. See: https://www.eorc.jaxa.jp/ALOS/en/dataset/"
            )
        session = AuthSession(
    ...
    def get_capabilities(self) -> ProviderCapabilities:
        return ProviderCapabilities(
            ...
            supports_sar=True, supports_sub_meter=False,
            ...
            regions=["global"],
            resolution_min_m=5.0, resolution_max_m=30.0,
            endpoint_url=self.BASE_URL, docs_url="https://www.eorc.jaxa.jp/ALOS/en/dataset/",
