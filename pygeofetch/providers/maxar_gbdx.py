...
Very-high-resolution WorldView and GeoEye imagery. Requires Maxar subscription.
"""
...
class MaxarGbdxProvider(AbstractBaseProvider):
    ...
    def authenticate(self, credentials: Credentials) -> AuthSession:
        ...
        if self.REQUIRES_AUTH and not token and not credentials.username:
            raise AuthenticationError(
                f"{self.DISPLAY_NAME} requires credentials. See: https://developers.maxar.com/"
            )
        session = AuthSession(
    ...
    def get_capabilities(self) -> ProviderCapabilities:
        return ProviderCapabilities(
            ...
            endpoint_url=self.BASE_URL, docs_url="https://developers.maxar.com/",
