...
class ProcessingPipeline:
    ...
    def clip(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("clip", kwargs)); return self

    def reproject(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("reproject", kwargs)); return self

    def resample(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("resample", kwargs)); return self

    def cloud_mask(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("cloud_mask", kwargs)); return self

    def cloud_fill(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("cloud_fill", kwargs)); return self

    def atmos(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("atmos", kwargs)); return self

    def composite(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("composite", kwargs)); return self

    def mosaic(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("mosaic", kwargs)); return self

    def ndvi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("ndvi", kwargs)); return self

    def evi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("evi", kwargs)); return self

    def ndwi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("ndwi", kwargs)); return self

    def ndbi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("ndbi", kwargs)); return self

    def tct(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("tct", kwargs)); return self

    def pca(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("pca", kwargs)); return self

    def lst(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("lst", kwargs)); return self

    def vectorize(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("vectorize", kwargs)); return self

    def smooth(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("smooth", kwargs)); return self

    def zonal_stats(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("zonal_stats", kwargs)); return self

    def compress(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("compress", kwargs)); return self

    def cog(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("cog", kwargs)); return self

    def topo_correct(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("topo_correct", kwargs)); return self

    def pansharpen(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("pansharpen", kwargs)); return self

    def dnbr(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("dnbr", kwargs)); return self

    def savi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("savi", kwargs)); return self

    def nbr(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("nbr", kwargs)); return self

    def mndwi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("mndwi", kwargs)); return self

    def ndsi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("ndsi", kwargs)); return self

    def ndmi(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("ndmi", kwargs)); return self

    def albedo(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("albedo", kwargs)); return self

    def band_math(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("band_math", kwargs)); return self

    def buffer(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("buffer", kwargs)); return self

    def centroids(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("centroids", kwargs)); return self

    def add_geometry_metrics(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("add_geometry_metrics", kwargs)); return self

    def despeckle(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("despeckle", kwargs)); return self

    def calibrate(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("calibrate", kwargs)); return self

    def flood_map(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("flood_map", kwargs)); return self

    def coherence(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("coherence", kwargs)); return self

    def tile(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("tile", kwargs)); return self

    def stack(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("stack", kwargs)); return self

    def texture(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("texture", kwargs)); return self

    def regularize(self, **kwargs) -> "ProcessingPipeline":
        self._steps.append(ProcessingStep("regularize", kwargs)); return self
    ...
    def set_schedule(self, cron: str) -> "ProcessingPipeline":
        self._schedule = cron; return self

    def output_dir(self, path: Union[str, Path]) -> "ProcessingPipeline":
        self._output_dir = Path(path); return self
    ...
    def _execute_step(
        ...
        if self._engine is None:
            raise RuntimeError("Pipeline has no engine — create via client.pipeline('name')")
        ...
        if handler is None:
            raise ValueError(f"Unknown pipeline step type: {st!r}")
        return handler()
    ...
    @classmethod
    def from_yaml(cls, path: Union[str, Path], engine=None) -> "ProcessingPipeline":
