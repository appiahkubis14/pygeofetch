...
```bash
cd PyGeoFetch-1.3.0-complete/pygeofetch
...
version = "1.3.0"            # must match git tag
...
# You should see:
# dist/
#   pygeofetch-1.3.0.tar.gz      ← source distribution (conda uses this)
#   pygeofetch-1.3.0-py3-none-any.whl  ← wheel
```
...
# Expected output:
# Checking dist/pygeofetch-1.3.0.tar.gz: PASSED
# Checking dist/pygeofetch-1.3.0-py3-none-any.whl: PASSED
```
...
sha256sum dist/pygeofetch-1.3.0.tar.gz

# Or download from PyPI and hash it:
pip download pygeofetch==1.3.0 --no-deps -d /tmp/pgf/
sha256sum /tmp/pgf/pygeofetch-1.3.0.tar.gz
```
...
```yaml
source:
  url: https://pypi.io/packages/source/p/pygeofetch/pygeofetch-1.3.0.tar.gz
...
# anaconda upload /path/to/pygeofetch-1.3.0-py39_0.tar.bz2
